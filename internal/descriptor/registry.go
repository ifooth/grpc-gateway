...
import (
	...
	"github.com/ifooth/grpc-gateway/v2/internal/codegenerator"
	"github.com/ifooth/grpc-gateway/v2/internal/descriptor/openapiconfig"
	"github.com/ifooth/grpc-gateway/v2/protoc-gen-openapiv2/options"
...
// SetVisibilityRestrictionSelectors Set a selector without visibility restrictions.
func (r *Registry) SetIncludeWithoutVisibility(include bool) {
	r.includeWithoutVisibility = include
}

// GetIncludeWithoutVisibility selector without visibility restrictions.
