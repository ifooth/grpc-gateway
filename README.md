...
import (
    _ "github.com/ifooth/grpc-gateway/v2/protoc-gen-grpc-gateway"
    _ "github.com/ifooth/grpc-gateway/v2/protoc-gen-openapiv2"
...
```sh
$ go install \
    github.com/ifooth/grpc-gateway/v2/protoc-gen-grpc-gateway \
    github.com/ifooth/grpc-gateway/v2/protoc-gen-openapiv2 \
...
import (
  ...
  "github.com/ifooth/grpc-gateway/v2/runtime"
...
```shell
$ go get github.com/ifooth/grpc-gateway/v2@v2.16.2
```
